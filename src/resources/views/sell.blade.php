    ...
    <form action="/sell" method="post" enctype="multipart/form-data">
      ...
      <div class="sell-form__group">
        ...
        <div class="sell-form__image-inputs">
          <img class="sell-form__image-input" name="preview_image" src="#" alt="" id="preview-image">
          <input type="file" id="image" name="image" accept="image/*" hidden>
          <label for="image" class="custom-file-label">画像を選択する</label>
        </div>
        <div class="sell-form__error-message">
          @error('image')
            {{ $message }}
          @enderror
        </div>
        ...
        <div class="sell-form__category-inputs">
          <div class="sell-form__category-check">
            ...
            <label class="sell-form__category-label">
              ...
              <span class="sell-form__category-text" for="category_{{ $category['id'] }}">
