  ...
  <div class="address-form__inner">
    ...
    <form class="address-form__form" action="/purchase/address/{{ $item_id }}" method="post">
      ...
      <div class="address-form__group">
        ...
        <input class="address-form__input" type="text" name="postal_code" id="postal_code" value="{{ $user->user_postal_code }}">
      ...
      <div class="address-form__group">
        ...
        <input class="address-form__input" type="text" name="address" id="address" value="{{ $user->user_address }}">
        <p class="address-form__error-message">
          @error('address')
          {{ $message }}
          @enderror
      ...
      <div class="address-form__group">
        ...
        <input class="address-form__input" type="text" name="building" id="building" value="{{ $user->user_building }}">
      </div>
